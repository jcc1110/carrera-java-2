 ...
 * @author Carlos
 */
public class Tiendadepeliculasmodificar {
    /**
   ...
   //declaramos la variables
		...
		do{
			System.out.print("Codigo de la pelicula a modificar: ");
			codigo=lector.nextInt();
			
			
			System.out.print("Desea modificar esta pelicula? ");
			res=lector.next().charAt(0);
		}while(res!='s');
		//Ahora los resultados
		System.out.println("La pelicula ha sido modificada con exito " );
