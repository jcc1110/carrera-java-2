 ...
 * @author Carlos
 */
public class Tiendapeliculasbuscar {
   ...
   //declaramos la variables
		...
		int codigo=0;
                System.out.println("Bienvenidos a la Tienda de Peliculas por favor coloque la letra O para escoger una opciíon y continuar :");
        // Esperando el dato
		...
		do{
			System.out.print("Teclea elcodigo de la pelicula: ");
			codigo=lector.nextInt();
			
			
			System.out.print("Desea buscar otra pelicula? ");
			res=lector.next().charAt(0);
		}while(res!='n');
		//Ahora los resultados
		System.out.println("El ultimo codigo de la pelicula  es: " + codigo);
