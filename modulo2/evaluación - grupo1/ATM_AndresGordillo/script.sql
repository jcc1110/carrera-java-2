...
INSERT INTO usuario (tarjeta, usuario, clave, saldo) VALUES ("12345","agordillo","12345",1200);
INSERT INTO usuario (tarjeta, usuario, clave, saldo) VALUES ("54321","mleon","12345",2000);
...
select * from usuario u inner join movimiento m on u.id = m.id_usuario where tarjeta=12345;
